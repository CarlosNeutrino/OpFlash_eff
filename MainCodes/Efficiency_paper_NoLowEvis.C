...
// MAIN CODE
void Efficiency_paper_NoLowEvis(){
    ...
    */
    ...
    for(string file : filenames){
        ...
        if(file.find("OldMC") != std::string::npos){
            ...
            l1->Draw("SAME");
            pt2->Draw("SAME");
            c1->SaveAs("Efficiency_all/OldMC/Efficiency_drift_highEvis.pdf");
            ...
            l2->Draw("SAME");
            pt2->Draw("SAME");
            c1->SaveAs("Efficiency_all/OldMC/Efficiency_Evis_highEvis.pdf");
            ...
            l1->Draw("SAME");
            pt2->Draw("SAME");
            c1->SaveAs("Efficiency_all/NewMC/Efficiency_drift_highEvis.pdf");
            ...
            l2->Draw("SAME");
            pt2->Draw("SAME");
            c1->SaveAs("Efficiency_all/NewMC/Efficiency_Evis_highEvis.pdf");
        }
