    ...
    */
    ...
    for(string file : filenames){
        ...
        if(file.find("OldMC") != std::string::npos){
            ...
            l1->Draw("SAME");
            pt2->Draw("SAME");
            c1->SaveAs("Efficiency_all/OldMC/Efficiency_drift_nu.pdf");
            ...
            l2->Draw("SAME");
            pt2->Draw("SAME");
            c1->SaveAs("Efficiency_all/OldMC/Efficiency_Evis_nu.pdf");
            ...
            l1->Draw("SAME");
            pt2->Draw("SAME");
            c1->SaveAs("Efficiency_all/NewMC/Efficiency_drift_nu.pdf");
            ...
            l2->Draw("SAME");
            pt2->Draw("SAME");
            c1->SaveAs("Efficiency_all/NewMC/Efficiency_Evis_nu.pdf");
        }
